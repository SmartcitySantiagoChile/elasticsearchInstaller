...
if $project_configuration; then
  ...
  sed -i -e 's/EMAIL_PORT=/EMAIL_PORT='"$EMAIL_PORT"'/g' "$CONFIGURATION_FILE"
  sed -i -e 's/EMAIL_USE_TLS=/EMAIL_USE_TLS='"$EMAIL_USE_TLS"'/g' "$CONFIGURATION_FILE"
  sed -i -e 's/EMAIL_HOST_USER=/EMAIL_HOST_USER='"$EMAIL_HOST_USER"'/g' "$CONFIGURATION_FILE"
  sed -i -e 's/EMAIL_HOST_PASSWORD=/EMAIL_HOST_PASSWORD='"$EMAIL_HOST_PASSWORD"'/g' "$CONFIGURATION_FILE"
